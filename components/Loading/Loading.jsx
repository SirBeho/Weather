...
export default function Loading({ activo }) {
    return (
        <div className={`sideBar ${activo ? "activa" : ""} d-flex vh-100  flex-column justify-content-center align-items-center`} style={{ background: "#33495f", zIndex: "2", position: "absolute" }}>
